export const STORIES = [
...

  {
    ...
    body: [
      ...
      "Epstein was arrested at Teterboro five months and two weeks later. Sultan Ahmed Bin Sulayem resigned as DP World chairman on February 13, 2026, five days after the Epstein files became public.",
    ],
    email_ids: [
      "EFTA02411125-0",
      "EFTA01814737-0",
    ...
    body_fr: [
      ...
      "Epstein fut arrêté à Teterboro cinq mois et deux semaines plus tard. Sultan Ahmed Bin Sulayem a démissionné de la présidence de DP World le 13 février 2026, cinq jours après la publication des fichiers Epstein.",
    ],
    news_links: [
      {
        title: "Epstein Flipped Israel's Gaza-Tested Biometric Scanners Into Nigeria Ports Deal for UAE",
